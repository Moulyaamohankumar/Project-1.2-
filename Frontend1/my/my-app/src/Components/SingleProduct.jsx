...
const Singleproductpage = () => {
    ...
    const addToCart=async(email,productid,quantity,productname)=>{
        try{
...
<div className="flex flex-wrap gap-x-5 mt-3 mb-5 items-start">
                            ...
                            <div className="flex flex-wrap gap-x-5 my-3">
                                <button onClick={addToCart} className="bg-black text-white px-5 py-2 rounded-full hover:bg-neutral-800 hover:-translate-y-1.5 active:translate-y-0 transition-transform duration-200 ease-in-out active:duration-0 active:ease-linear">
                                    Add to Cart
                                </button>
                            </div>
</div>
